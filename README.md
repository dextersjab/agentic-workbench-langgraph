...
This project is structured to enable the effective development of agentic workflows and works best when used in conjuction with [Open WebUI](https://openwebui.com/)—the popular open-source ChatGPT-like interface—as your frontend.
