...
from ..prompts.clarify_issue_prompt import CLARIFICATION_PROMPT, ANALYSIS_PROMPT
...
async def clarify_issue_node(state: HelpHubState) -> HelpHubState:
    """
    ...
    try:
        ...
        if needs_clarification:
            ...
            clarification_prompt = CLARIFICATION_PROMPT.format(
                ...
                missing_info="General clarification needed"
            )
...
# Removed the manual rule-based clarification function as we now use LLM for everything