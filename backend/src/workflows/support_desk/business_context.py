...
ISSUE_CATEGORIES = {
    ...
    "other": {"keywords": [], "typical_team": "L1", "escalation_triggers": []},
}

# Extend company teams with workflow-specific definitions
SUPPORT_TEAMS = {**COMPANY_SUPPORT_TEAMS}
...
def get_routing_decision(
    issue_category: str, issue_priority: str, conversation_text: str = ""
) -> dict:
    """
...
REQUIRED_INFO_CATEGORIES = {
    ...
    "timeline": {
        ...
        "description": [
            ...
            "How often it happens (once/intermittent/constant)",
    ...
    "context": {
        "name": "Context",
        "description": [
            "What was being attempted when issue occurred",
            "Recent system or environment changes",
...
CATEGORY_SPECIFIC_PRIORITIES = {
    "hardware": {
        ...
        "priorities": [
            "Device models",
            "Physical symptoms",
            "Connectivity (Dell/Lenovo equipment)",
        ],
    },
    "software": {
        "name": "Software",
        "priorities": [
            ...
            "Error messages",
            "Affected workflows (ServiceHub Portal, Dynamics 365, Salesforce CRM, Azure AD)",
        ],
    },
    "access": {
        "name": "Access",
        "priorities": [
            "Account names",
            "Systems",
            "Permission levels (consider department-specific procedures)",
        ],
    },
    "network": {
        "name": "Network",
        "priorities": [
            "Connection types",
            "Locations",
            "Affected devices (London HQ, Manchester, Edinburgh, remote workers)",
        ],
    },
}
