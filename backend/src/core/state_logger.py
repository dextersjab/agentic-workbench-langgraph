...
def log_node_start(node_name: str, reads: List[str], state: Dict[str, Any] = None) -> None:
    """
...
def log_node_complete(node_name: str, state_before: Dict[str, Any], state_after: Dict[str, Any]) -> None:
    """
        ...
        if key not in state_before:
            ...
            if isinstance(value, dict) and isinstance(state_before[key], dict):
                ...
                for nested_key in value.keys():
                    if nested_key not in state_before[key] or state_before[key][nested_key] != value[nested_key]:
...
def log_state_access(node_name: str, state_before: Dict[str, Any], state_after: Dict[str, Any], 
