...
def pydantic_to_json_schema(model_class: Type[BaseModel], schema_name: str) -> Dict[str, Any]:
    """
...
def extract_tool_call_args(response: Dict[str, Any], expected_tool_name: str = None) -> Dict[str, Any]:
    ...
    if expected_tool_name:
        ...
        if actual_name != expected_tool_name:
            raise ValueError(f"Expected tool '{expected_tool_name}', got '{actual_name}'")
