# Agentic Workflow Workbench Makefile
...
# Default target
help:
	@echo "Agentic Workflow Workbench - Available commands:"
	@echo ""
	@echo "Setup Commands:"
...
setup: setup-all
setup-all:
	@echo "🔧 Setting up Agentic Workflow Workbench..."
	@if [ ! -f .env ]; then \
...
# Start/Stop commands
start:
	@echo "🚀 Starting Agentic Workflow Workbench..."
	@docker compose up -d
